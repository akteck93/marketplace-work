...
// This is a utility endpoint — only call once to seed categories
// Call GET /api/admin/seed-categories to populate the database
export async function GET() {
  ...
  try {
    ...
    return NextResponse.json({ 
      success: true, 
      message: `Seeding complete. Created: ${created}, Skipped (already existed): ${skipped}` 
    });
  } catch (error) {
